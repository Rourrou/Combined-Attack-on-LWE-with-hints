...
def sol_perfect_hints(m, k, solution):
    ...
    with open("Data/Perfect Hints/secret error/Kyber128/v.txt", 'r') as f:
        lines_V = [next(f) for _ in range(nb_of_hints)]
    V = np.loadtxt(lines_V)

    with open("Data/Perfect Hints/secret error/Kyber128/l.txt", 'r') as g:
...
if __name__ == "__main__":
    with open("Data/Perfect Hints/secret error/Kyber128/es.txt", 'r') as g:
